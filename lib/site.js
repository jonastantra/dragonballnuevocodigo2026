...
export const categoryPages = [
  {
    ...
    editorial: {
      ...
      faqs: [
        {
          question: "¿Dónde ver Dragon Ball Super en español latino completo online?",
          answer: "Puedes ver todos los 131 capítulos de Dragon Ball Super en audio latino HD completos en Dragon Ball HD Sin Límites."
        },
        {
          question: "¿En qué episodio Goku activa el Ultra Instinto?",
          answer: "Goku activa la Doctrina Egoísta (Ultra Instinto) por primera vez en el episodio 110 durante el Torneo del Poder."
        }
      ]
    },
  },
  {
    ...
    editorial: {
      ...
      faqs: [
        {
          question: "¿Cuántos capítulos tiene Dragon Ball Super subtitulado?",
          answer: "Cuenta con los 131 episodios originales de Toei Animation emitidos en japonés con subtítulos en español neutro."
        }
      ]
    },
  },
  {
    ...
    editorial: {
      ...
      faqs: [
        {
          question: "¿Cuántos episodios tiene Dragon Ball Z en audio latino?",
          answer: "Dragon Ball Z cuenta con 291 episodios divididos en las sagas Saiyajin, Freezer, Cell y Majin Boo en español latino HD."
        },
        {
          question: "¿En qué capítulo Goku se transforma en Super Saiyajin Fase 1?",
          answer: "Goku se transforma por primera vez en Super Saiyajin en el episodio 95 tras la muerte de Krilin en Namekusei."
        }
      ]
    },
  },
  {
    ...
    editorial: {
      ...
      faqs: [
        {
          question: "¿Cuántos capítulos tiene Dragon Ball GT?",
          answer: "Dragon Ball GT consta de 64 capítulos divididos en 4 sagas completas en audio latino HD."
        }
      ]
    },
  },
  {
    ...
    editorial: {
      ...
      faqs: [
        {
          question: "¿Qué diferencia hay entre Dragon Ball Z y Dragon Ball Kai?",
          answer: "Dragon Ball Kai es la versión remasterizada en HD 1080p sin contenido de relleno que resume la historia en 167 episodios calcados del manga."
        }
      ]
    },
  },
  {
    ...
    editorial: {
      ...
      faqs: [
        {
          question: "¿Cuántos capítulos tiene la serie clásica de Dragon Ball?",
          answer: "Dragon Ball clásico consta de 153 episodios que abarcan desde el encuentro con Bulma hasta el torneo de artes marciales contra Piccolo."
        }
      ]
    },
  },
  {
    ...
    editorial: {
      ...
      faqs: [
        {
          question: "¿Cuántas películas de Dragon Ball están disponibles online?",
          answer: "Están disponibles las 21 películas oficiales, OVAs y especiales de TV de Dragon Ball, DBZ y Super en audio latino HD."
        }
      ]
    },
  },
...
export function getCategoryFaqSchema(category) {
  if (!category?.editorial?.faqs?.length) return null;
  const canonicalPath = category.canonical || category.canonicalPath || category.path;
  const canonicalUrl = `${siteUrl}${canonicalPath}`;
  ...
  return {
    ...
    "@type": "FAQPage",
    "@id": `${canonicalUrl}#faq`,
    mainEntity: category.editorial.faqs.map((faq) => ({
      "@type": "Question",
      name: faq.question,
      acceptedAnswer: {
        "@type": "Answer",
